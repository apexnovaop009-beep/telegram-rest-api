...
-- CreateIndex
CREATE INDEX "messages_session_id_id_status_idx" ON "messages"("session_id", "id", "status");

-- CreateIndex
CREATE INDEX "messages_session_id_to_account_id_status_idx" ON "messages"("session_id", "to_account", "id", "status");
...
-- CreateIndex
CREATE UNIQUE INDEX "tenant_message_state_session_id_from_account_to_account_key" ON "tenant_message_state"("session_id", "from_account", "to_account");

-- AddForeignKey
ALTER TABLE "messages" ADD CONSTRAINT "messages_session_id_fkey" FOREIGN KEY ("session_id") REFERENCES "telegram_sessions"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "attachments" ADD CONSTRAINT "attachments_message_id_fkey" FOREIGN KEY ("message_id") REFERENCES "messages"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "tenant_message_state" ADD CONSTRAINT "tenant_message_state_session_id_fkey" FOREIGN KEY ("session_id") REFERENCES "telegram_sessions"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
